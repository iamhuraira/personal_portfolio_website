  ...
  return (
      <div className="intro">
          ...
          <div className="i-right">
              ...
              <motion.img
                  initial={{ left: '-400px' }}
                  whileInView={{ left: '-320px'}}
                  transition={transition}
                  src={glassesimoji} alt="" />
              <motion.div
                  initial={{ left: '50%', top: '-1%' }}
                  whileInView={{ left: '65%' }}
                  transition={transition}
                  
                  style={{ top: '-1%', left: '65%' }}
                className='floating-div floating-div-1'
              >
                  <FloatingDiv image={Crown} txt1={'MERN Stack'} txt2={'Developer'} />
              </motion.div>
              <motion.div
                  initial={{ left: '55rem', top: '49rem' }}
                  whileInView={{ left: '18rem' }}
                  transition={transition}
                  style={{ left: '55rem', top: '49rem' }}
                  className='floating-div floating-div-2'>
